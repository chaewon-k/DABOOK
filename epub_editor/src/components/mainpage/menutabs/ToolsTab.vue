  ...
  <div id="subMenuBar">
    <v-tabs show-arrows v-model="tab" class="left ml-3">
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('LineTag')"
              >mdi-minus</v-icon
            ></v-btn
          ></template
        >
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('BlockquoteTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('CiteTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('BoldTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('UnderlineTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('MediumlineTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('SubscriptTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('SuperscriptTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('UnorderedListTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('OrderedListTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('ImageTag')"
      ...
      <v-tooltip bottom
        ><template v-slot:activator="{ on }">
          <v-btn class="align-self-center rounded-sm" v-on="on" icon medium
            ><v-icon medium @click="selectTag('Link')"
